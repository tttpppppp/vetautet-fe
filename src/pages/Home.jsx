        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="py-20 bg-tet-red relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 text-center relative z-10">
                    <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Sẵn sàng cho hành trình?</h2>
                    <p className="text-red-100 text-lg mb-10 max-w-2xl mx-auto font-medium">
                        Hàng ngàn vé tàu đang chờ đợi bạn. Đặt vé ngay để tận hưởng hành trình tuyệt vời với mức giá tốt nhất.
                    </p>
